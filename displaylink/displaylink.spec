...
%endif
Source1:  https://raw.githubusercontent.com/displaylink-rpm/displaylink-rpm/master/displaylink-driver.service
Source2:  https://raw.githubusercontent.com/displaylink-rpm/displaylink-rpm/master/99-displaylink.rules
Source3:  https://raw.githubusercontent.com/displaylink-rpm/displaylink-rpm/master/displaylink-sleep-extractor.sh
...
Source4:  https://www.synaptics.com/sites/default/files/exe_files/2023-08/DisplayLink%20USB%20Graphics%20Software%20for%20Ubuntu5.8-EXE.zip
Source5:  https://raw.githubusercontent.com/displaylink-rpm/displaylink-rpm/master/20-displaylink.conf
Source6:  https://raw.githubusercontent.com/displaylink-rpm/displaylink-rpm/master/95-displaylink.preset
...
cd %{_builddir}/displaylink-%{version}/displaylink-driver-%{_daemon_version}/%{target_arch}-ubuntu-1604/

patchelf --set-rpath '$ORIGIN' DisplayLinkManager
...
# CentOS 7 still has an older libusbx. Copy over for this distro.
...
cp -a %{target_arch}-ubuntu-1604/DisplayLinkManager %{buildroot}%{_libexecdir}/%{name}/

%if 0%{?rhel} && 0%{?rhel} <= 7
cp -a %{target_arch}-ubuntu-1604/libusb-1.0.so.0.2.0 %{buildroot}%{_libexecdir}/%{name}/
